...
parser.add_argument("--n-samples", dest="n_samples",
                    help="number of samples in the dataset", required=True, type=int)
parser.add_argument("--manual-seed", dest="manual_seed",
                    help="seed for random permutation", default=torch.manual_seed(randint(0, 1e6)))
...
async def lifespan(app: FastAPI):
    ...
    split_indices = [shuffled_indices[i:i+partition_size]
...
if __name__ == "__main__":
    uvicorn.run("fl.genotypes.scripts.run_data_split_service:app",
